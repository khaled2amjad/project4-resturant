...
function addToCart(productId, productName, productPrice, productImage) {
    ...
    if (existingItem) {
        ...
        cart.push({
            ...
            name: productName,
            price: productPrice,
            image: productImage || 'c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg',
            quantity: 1
        });
    }
...
function renderCartItems() {
    ...
    cartItemsContainer.innerHTML = cart.map(item => {
        const imageUrl = item.image || item.img || 'c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg';
        console.log('Cart item:', item.name, 'Image URL:', imageUrl);
        return `
        <div class="cart-item">
            <img src="${imageUrl}" alt="${item.name}" class="cart-item-image" onerror="this.src='c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg'">
...
function renderMenuGrid() {
    ...
    grid.innerHTML = pageItems.map(item => {
        ...
        const imageUrl = item.img ? item.img.replace(/\\u0026/g, '&') : 'c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg';
        console.log('Product:', item.name, 'Image URL:', imageUrl);

        return `
            <article class="menu-card" data-id="${item.id}">
                <div class="menu-card-image-wrapper">
                    <img src="${imageUrl}" alt="${item.name}" class="menu-card-image" onerror="this.src='c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg'">
                </div>
...
function renderProductDetails(product) {
    ...
    if (productImageEl) {
        productImageEl.src = product.img ? product.img.replace(/\\u0026/g, '&') : 'c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg';
        productImageEl.alt = product.name;
        productImageEl.onerror = function() {
            this.src = 'c:/Desktop/project4cursor/assests/istockphoto-1184633031-612x612.jpg';
        };
    }
